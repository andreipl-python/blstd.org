...
1. Сгенерировать человекочитаемый релиз-нот в **Markdown**, в духе Notion-шаблона:
...
Этот воркфлоу должен полностью выполняться каждый раз, когда пользователь присылает отдельным сообщением команду `фиксируем` в контексте репозитория `blstd.org`.