...
- [High · 2 h · Planned] Проработка формы создания бронирований: разделение общих и блочных полей (клиент, комната, направление, специалист — общие; дата, время, длительность, доп. услуги, комментарий — в блоке), лимит 3 блока, копирование предыдущего блока, правила удаления, отображение ошибок по блокам
- [High · 4 h · Planned] UI добавления нескольких блоков в модалке создания: кнопка добавления, копирование предыдущего блока, лимит 3 блока, удаление, заголовки блоков
- [High · 4 h · Planned] Модель данных формы в виде массива блоков: синхронизация общих полей, независимые поля блоков, корректная сборка запроса
