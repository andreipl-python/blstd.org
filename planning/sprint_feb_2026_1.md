...
- [High · 4 h · Done] Модель «Специалист»: M2M со сценариями + правила выборки/фильтрации специалистов по сценарию
- [High · 6 h · Done] Расписание специалистов (Backend): модель рабочих интервалов с привязкой к сценарию, миграция, формы/админка
- [High · 6 h · Done] Расписание специалистов (Backend): логика пересечений между сценариями, валидация, мерж интервалов
- [High · 4 h · Done] Расписание специалистов (Backend): endpoint/контракт для календаря (группы по ролям, фильтр по сценарию, диапазон дат)
