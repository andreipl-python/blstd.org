...
- [High · 5 h · Not Started] Модальное окно истории оплат: загрузка и отображение истории платежей по брони (дата, сумма, способ оплаты)
- [Medium · 3 h · Not Started] Модальное окно редактирования платежа: фронтовый шаблон и базовая вёрстка отдельной модалки редактирования платежа (поля суммы, способа оплаты и комментария)
