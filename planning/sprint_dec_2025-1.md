...
- [High · 14 h · Done] Подготовить API/сервис для работы с диапазонами дат и часов работы объектов
- [High · 24 h · Done] Реализовать UI-компонент календаря на два месяца с навигацией и множественным выбором диапазона
...
- [High · 14 h · Done] Интегрировать календарь с фильтрами и таблицей броней (передача выбранных диапазонов, обновление данных)
- [Medium · 8 h · Done] Добавить предустановленные диапазоны (сегодня, 7 дней, месяц, настраиваемый диапазон и т.д.)
- [Medium · 1 h · Done] Дефолт фильтра объектов: первая запись
- [Medium · 1 h · Done] Дефолт фильтра сценариев: первая запись

**Итого по разделу 2.2:** 24 h  
Суммарно разделы 2.1–2.2: 62 h

---

### 2.3. Календарь и таблица броней

- [High · 3 h · Done] Дефолтное время в календаре = время работы сценария (кратно часу)

**Итого по разделу 2.3:** 3 h  
Суммарно разделы 2.1–2.3: 65 h
...
- [Medium · 0,25 h · Done] Модальное окно подтверждения отмены: запрет закрытия по клику вне границ окна (только по кнопкам)
- [Medium · 2 h · Done] Подтверждение отмены платежа через модальное окно подтверждения отмены с кастомным текстом и описанием последствий для оплаты

**Итого по разделу 2.4:** 29,25 h  
Суммарно разделы 2.1–2.4: 94,25 h

---

## 3. Итог спринта

- Плановый объём спринта: **≈94,25 h**.
