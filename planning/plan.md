...
- **Модальные окна**
  - **Добавление клиента**
    - [High · 2 h] Шаблон модального окна добавления клиента
    - [Medium · 1 h] Перенос дизайна модального окна добавления клиента из Figma
    - [Medium · 1 h] Шаблон модального окна обратной связи после добавления клиента
    - [Medium · 1 h] Перенос дизайна модального окна обратной связи после добавления клиента из Figma
  ...
  - **Добавление брони**
    - [Medium · 2 h] Видоизменённый шаблон модального окна добавления брони для сценария «Репетиционная точка»
    - [Medium · 2 h] Видоизменённый шаблон модального окна добавления брони для сценария «Музыкальный класс»
    - [Medium · 1 h] Шаблон модального окна обратной связи после добавления брони
    - [Medium · 1 h] Перенос дизайна модального окна обратной связи после добавления брони из Figma
  - **Информация о брони**
    - [Medium · 2 h] Видоизменённый шаблон модального окна информации о брони для сценария «Репетиционная точка»
    - [Medium · 2 h] Видоизменённый шаблон модального окна информации о брони для сценария «Музыкальный класс»
  - **Редактирование брони**
    - [Medium · 2 h] Видоизменённый шаблон модального окна редактирования брони для сценария «Репетиционная точка»
    - [Medium · 2 h] Видоизменённый шаблон модального окна редактирования брони для сценария «Музыкальный класс»
  - **Удаление брони**
...
- **Бронирования и расписание**
  ...
  - [High · 4 h] Функционал подстановки нужного модального окна добавления брони в зависимости от выбранного сценария («Репетиционная точка» / «Музыкальный класс»)
  - [High · 4 h] Функционал подстановки нужного модального окна информации о брони в зависимости от сценария брони
  - [High · 4 h] Функционал подстановки нужного модального окна редактирования брони в зависимости от сценария брони
  - [Medium · 2 h] Функционал модального окна обратной связи после добавления брони
...
- **Клиенты и абонементы**
  - [High · 4 h] Функционал добавления клиента (валидации, сохранение, интеграция с календарём/бронями)
  - [Medium · 1 h] Отмена добавления клиента через существующее модальное окно подтверждения отмены действия
