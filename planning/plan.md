...
- **Оплаты и биллинг**
  ...
  - [Medium · 3 h] Модальное окно редактирования платежа: фронтовый шаблон и базовая вёрстка отдельной модалки редактирования платежа (поля суммы, способа оплаты)
  - [High · 5 h] Модальное окно редактирования платежа: функционал изменения параметров платежа (сумма, способ оплаты) с валидацией и обновлением показателей «Внесено» и «Остаток» в истории платежей
