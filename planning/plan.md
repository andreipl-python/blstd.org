...
- **Календарь и таблица**
  ...
  - [High · 6 h] Сетка календаря по режиму работы комнаты (ограничение отображаемого времени рабочими часами комнаты, деактивация ячеек вне рабочего времени сценария)
...
- **Модальные окна**
  - **Создание/редактирование брони (UI ошибок)**
    - [High · 2 h] Единый стиль предупреждений/ошибок в модалках создания/редактирования брони: красный текст
    - [High · 2 h] Единый стиль предупреждений/ошибок в модалках создания/редактирования брони: красная рамка полей
    - [Medium · 0,5 h] Модалки создания/редактирования брони: предупреждение «Не выбрана длительность» (текст/расположение/визуальные состояния)
    - [Medium · 1 h] Селект преподавателя: плейсхолдер «Нет доступных преподавателей» + disabled состояние (включая визуальные состояния)
...
- **Бронирования и расписание**
  ...
  - [High · 6 h] Специалисты: модель расписания работы специалиста с возможностью нескольких интервалов в один день (БД/миграция/админка)
  - [High · 8 h] Специалисты: пересчёт доступности на основе расписания (интервалы в рамках дня) и интеграция в проверки доступности брони
  - [Medium · 2 h] Специалисты: правило недоступности при бронировании специалистом «под себя как клиент»
  - [High · 6 h] Услуги специалистов: модель (название, активность, стоимость, длительность) + связь many‑to‑many со специалистами + админка
  - [High · 6 h] Услуги специалистов: интеграция в модалки создания/редактирования брони (загрузка списка, сохранение в бронь, валидации)
  - [High · 8 h] Музыкальная школа: длительность брони от выбранной услуги специалиста (автоподстановка/ограничения длительности)
  - [High · 10 h] Тарифы (Репетиционная точка/Музыкальный класс): модель тарифов и ограничений (дни недели, время, комнаты, количество людей, длительность, стоимость)
  - [High · 8 h] Тарифы: интеграция в модалки брони (фильтрация доступных тарифов по сценарию/комнате/времени/количеству людей, валидации)
  - [High · 6 h] Календарь: «дыры» в расписании по тарифам (недоступные ячейки, если тарифы не закрывают рабочие интервалы)
  - [High · 4 h] Бронирования: поле «количество людей» в модели брони + запись/редактирование/отображение в модалках (создание/редактирование/инфо)
