...
- [Medium · 1 h · Planned] Шаблон модального окна обратной связи после внесения оплаты
- [Medium · 1 h · Planned] Перенос дизайна модального окна обратной связи после внесения оплаты из Figma
- [High · 2 h · Planned] Единый стиль предупреждений/ошибок в модалках создания/редактирования брони: красный текст
- [High · 2 h · Planned] Единый стиль предупреждений/ошибок в модалках создания/редактирования брони: красная рамка полей
- [Medium · 0,5 h · Planned] В модалках создания/редактирования брони: предупреждение о не выбранной длительности (текст/расположение/визуальные состояния)
- [Medium · 1 h · Planned] Селект преподавателя: плейсхолдер «Нет доступных преподавателей» + disabled состояние (включая визуальные состояния)
...
- [High · 6 h · Planned] Специалисты: модель расписания работы специалиста с возможностью нескольких интервалов в один день (БД/миграция/админка)
- [High · 8 h · Planned] Специалисты: пересчёт доступности на основе расписания (интервалы в рамках дня) и интеграция в проверки доступности брони
- [Medium · 2 h · Planned] Специалисты: правило недоступности при бронировании специалистом «под себя как клиент»
...
- [High · 3 h · Planned] Модальное окно оплаты: интерактивный пересчёт показателя «Остаток» при изменении сумм в полях ввода (мгновенное обновление блока «Стоимость / Внесено / Остаток» без перезагрузки модального окна)
- [Medium · 2 h · Planned] Функционал модального окна обратной связи после внесения оплаты
