...
from .views.payment_processing import process_batch_payments_view
...
routes = [
    ...
    (r"service_groups", ServiceGroupViewSet),
...
urlpatterns = [
    ...
    path(
        "booking/cancel/<int:booking_id>/", cancel_booking_view, name="cancel_booking"
    ),
    path(
    ...
    path(
        "booking/process-batch-payments/<int:booking_id>/",
        process_batch_payments_view,
        name="process_batch_payments",
    ),
    path(
    ...
    path(
        "booking/get-available-specialists/<int:booking_id>/",
        get_available_specialists,
        name="get_available_specialists",
    ),
    path("booking/get-clients/", get_clients, name="get_clients"),
    path(
        "booking/update-client/<int:booking_id>/",
        update_booking_client,
        name="update_booking_client",
    ),
    path("booking/get-services/", get_services, name="get_services"),
    path(
        "booking/update-services/<int:booking_id>/",
        update_booking_services,
        name="update_booking_services",
    ),
    path(
        "booking/delete-service/<int:booking_id>/",
        delete_booking_service,
