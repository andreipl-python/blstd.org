...
class TariffUnitViewSet(BaseViewSet):
    ...
    @extend_schema(
        ...
        responses=UniversalSchemas.list_schema(TariffUnitSerializer),
    )
    ...
    @extend_schema(
        ...
        responses=UniversalSchemas.create_schema(TariffUnitSerializer),
    )
    ...
    @extend_schema(
        ...
        responses=UniversalSchemas.retrieve_schema(TariffUnitSerializer),
    )
    ...
    @extend_schema(
        ...
        request=TariffUnitSerializer,
        responses=UniversalSchemas.update_schema(TariffUnitSerializer),
    )
    ...
    @extend_schema(
        ...
        request=TariffUnitSerializer,
        responses=UniversalSchemas.partial_update_schema(TariffUnitSerializer),
    )
    ...
    @extend_schema(
        ...
        responses=UniversalSchemas.destroy_schema(TariffUnitSerializer),
    )
